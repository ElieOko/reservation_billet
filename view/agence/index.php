...
<head>
    ...
    <title>Create Agence</title>
</head>
<body>
<div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-md">
    <h2 class="mt-6 text-center text-2xl font-bold leading-9 tracking-tight text-blue-300">Ajouter une nouvelle agence</h2>
  </div>
  ...
  <div class="rounded-md bg-green-50 p-4 mb-8 ">
    ...
    <div class="bg-white px-6 py-12 shadow sm:rounded-lg sm:px-12">
      ...
      <div>
          <label for="nom" class="block text-sm font-medium leading-6 text-gray-900">Nom de l'agence</label>
          <div class="mt-2">
